...
namespace PhGUtils {
  ...
  template <> 
  inline lapack_int xgels<float>(int order, lapack_int m, lapack_int n, lapack_int nrhs,
  ...
  template <> 
  inline lapack_int xgels<double>(int order, lapack_int m, lapack_int n, lapack_int nrhs,
  ...
  template <>
  inline lapack_int leastsquare_normalmat<double>(PhGUtils::DenseMatrix<double>& A, PhGUtils::DenseVector<double>& b,
  ...
  template <>
  inline lapack_int leastsquare_normalmat<float>(PhGUtils::DenseMatrix<float>& A, PhGUtils::DenseVector<float>& b,
